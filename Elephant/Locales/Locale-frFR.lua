...
L['maxlogwords']      = "Taille de log max"
L['maxlogwords_desc']  = "Taille maximale de chaque log."
...
L['copy']  = "Copier"
L['copyinfo']  = "Vous permet de copier la dernière ligne affichée et les %s lignes la précédant."
